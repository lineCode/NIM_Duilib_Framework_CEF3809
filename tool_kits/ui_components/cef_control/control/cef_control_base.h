...
public:
	...
	*/
	...
	void AttachDragEnter(const OnDragEnterEvent& callback) { cb_drag_enter_ = callback; }

	void AttachGetBrowserSettings(const OnGetBrowserSettingsEvent& callback) { cb_get_browser_sttings_ = callback; }
...
protected:
	...
	OnDragEnterEvent            cb_drag_enter_ = nullptr;
	OnGetBrowserSettingsEvent cb_get_browser_sttings_ = nullptr;
