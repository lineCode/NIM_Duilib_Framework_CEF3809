...
namespace ui 
{
	...
	typedef std::function<bool(CefRefPtr<CefBrowser>browser, CefRefPtr<CefDragData> dragData, CefDragHandler::DragOperationsMask mask)> OnDragEnterEvent;
	typedef std::function<CefBrowserSettings(void)> OnGetBrowserSettingsEvent;
}