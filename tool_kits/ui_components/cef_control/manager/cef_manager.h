...
public:
	...
	*/
	bool Initialize(const std::wstring& app_data_dir, CefSettings &settings, bool is_enable_offset_render = true, 
		const RegisterCustomSchemesCallback& register_custom_schemes_callback = nullptr, const BeforeCommandLineProcessingCallback& before_command_line_processing_callback = nullptr);
